...
import { educationData } from '@/libs/data/education.data'
import {
  Box,
  Button,
  Center,
...
export default function Home() {
  return (
    <>
      <title>{siteConfig.profile.metaTitle}</title>
...
const CmsStack = () => {
  const items = [
    { name: 'Shopify', badge: <FaShopify /> },
    { name: 'WordPress', badge: <FaWordpress /> },
    { name: 'Wix', badge: <FaWix /> },
    { name: 'Hubspot', badge: <FaHubspot /> },
    { name: 'SquareSpace', badge: <FaSquarespace /> },
  ]
        ...
        return (
          ...
          >
            <Stack alignItems="start">
              <Heading as="h3" fontSize="md" color={'brand'} fontWeight="bold" textAlign="start">
                {project.title}
              </Heading>
    ...
    <Stack gap={4} id="education">
      ...
      >
        {educationData.map((edu, index) => (
          <Stack key={index} gap={4} direction="column">
            <Flex justify={'space-between'} alignItems={'end'}>
              <Heading as="h3" fontSize="md" color={'brand'} fontWeight="bold" textAlign="start">
                {edu.institution}
              </Heading>
...
const Contact = () => {
  return (
    <Stack gap={6} marginBottom={10} id="contact">
      <Heading as={'h2'} fontSize={{ base: 'xl', md: 'xl' }} color={'brand'}>
        Contact
      </Heading>
